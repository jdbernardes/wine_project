...
class ValidationData:
    ...
    def generate_csv(self, df: pd.DataFrame) -> None:
        ...
        valid_data.to_csv(f"{self._validation_path}/validation_data.csv", index=False)
        return db_data


# Below piece of code is just for manual run so don't make sense to consider in tests
